...
using FunctionIngredientsPtr = IntrusivePtr<FunctionIngredients>;
...
public:
	...
	// (event).
	void AddBody(const detail::FunctionIngredientsPtr ingr, detail::StmtPtr new_body = nullptr);
...
class FunctionIngredients : public zeek::Obj
	{
public:
